...
The intercept is the lobster count when the site is not an MPA. The treat plus the intercept is the count when the site is an MPA. The p-value of the intercept is 0, which is means it is significant. The treat coefficient has a p value of .3, meaning that the coefficient is not statisticall significant. 
